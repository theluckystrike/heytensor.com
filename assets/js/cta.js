/*
 * cta.js - one-line promo strip for a related paid guide.
 *
 * Self-hosted copy of microtools/kit/cta.js. No external requests: the script is
 * served from this origin and only ever writes DOM into the page it sits in.
 *
 *   <script src="/assets/js/cta.js"
 *           data-mt-cta
 *           data-tool="reading-pytorch-shape-errors"
 *           data-href="https://theluckystrike.gumroad.com/l/reading-pytorch-shape-errors"
 *           data-text="One sentence explaining what the guide adds to this page."
...
(function () {
  ...
  /* Do not advertise a page the visitor is already on. Same-origin only: an
     off-site target can share a pathname with this page by coincidence. */
